...
<head><!--登录页面-->
    ...
    <!--头部-start-->
    <jsp:include page="/all/include/head.jsp"></jsp:include>
    <!--头部-end-->
    <!--导入css样式-->
    ...
    <div class="ucenter_body">
        <div class="ucenter_body_con">
            ...
            <div class="ucenter_body_right">
                <form id="signin" action="${pageContext.request.contextPath}/index.jsp" method="post" novalidate="novalidate">
                    ...
                    <div class="ucenter_btn">
                        ...
                        <a id="signin_login" href="${pageContext.request.contextPath}/registerandlogin.jsp">注册</a>
                    </div>
