...
<head>
    <meta charset="UTF-8">
    <title>『豪情』后台管理</title>
    <link href="${pageContext.request.contextPath}/static/back/css/admin_login.css" rel="stylesheet" type="text/css" />
</head>
<body>
            ...
            <form action="login" method="post">
                <ul class="admin_items">
                    ...
                    <li>
                        ...
                        <input type="password" name="pwd" value="" id="password" size="40" class="admin_input_style" />
                    </li>
                    <li>
